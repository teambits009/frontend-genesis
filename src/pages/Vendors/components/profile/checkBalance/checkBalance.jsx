    ...
    <div className="">
      ...
      <div className="shadow-custom rounded-xl p-5">
        ...
        <form className="grid gap-5">
          ...
          <div className="flex gap-[40px]">
            <button className="shadow-btn transition-all ease-in-out duration-500 w-[100%] border border-zinc-300 py-[10px] bg-[#015FF1] text-white px-[25px]">
              Request To Remove My Data
            </button>
            <button className="shadow-btn transition-all ease-in-out duration-500 border w-[100%] border-zinc-300 py-[10px]  text-white px-[25px]">Request My Data</button>
          </div>
        </form>
      </div>
    </div>
